...
def run_experiment(d=10, n=5, n_iter=None, s=1, epsilon=None, max_iter_cap=300, latex=False, force_cpu=False):
    """
    ...
    # Build family P_i = P_base^{2^{i-1}} for i=1..n_models-1, and a lazy chain for the last one
    P_list = []
    pi_list = []
