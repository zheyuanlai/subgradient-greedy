...
from projected_subgradient.src.algorithms.projected_subgradient import compute_h
...
def build_partition():
    """Fixed partition for d=5: [[0,1],[2,4],[3]]"""
    return [[0, 1], [2, 4], [3]]
...
def main():
    ...
    print("=" * 70)
    print("PROJECTED SUBGRADIENT EXPERIMENT ANALYSIS")
    print("=" * 70)
    ...
    if bl_results:
        ...
        # Save to CSV
        output_path = Path(__file__).parent / "results" / "bernoulli_laplace_analysis.csv"
    ...
    if cw_results:
        ...
        # Save to CSV
        output_path = Path(__file__).parent / "results" / "curie_weiss_analysis.csv"
    ...
    if bl_results and cw_results:
        ...
        # Save combined
        output_path = Path(__file__).parent / "results" / "combined_analysis.csv"
