...
def _get_logger():
    return _ExpLogger(root_dir='projected_subgradient', model_name='curie_weiss')
import json

def build_partition():
    # Fixed partition for d=5 as requested: [[1,2],[3,5],[4]] (convert to 0-based)
    return [[0,1],[2,4],[3]]

def run_experiment(n=5, n_iter=None, epsilon=None, max_iter_cap=150, latex=False):
    """Runs projected subgradient on d=5 Curie-Weiss Glauber dynamics (manuscript settings).
