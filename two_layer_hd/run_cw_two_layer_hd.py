"""
Run high-d two-layer algorithm on the Curie-Weiss model (d up to ~10).
"""
import os
import sys
import json
...
def run_cw_two_layer_hd(
    ...
    if eta is None:
        # η ≈ sqrt(n / (B * K)), use conservative B estimate
    ...
    if save_results:
        ...
        config = {
            'model': 'curie_weiss', 'd': d, 'n_models': n_models,
        ...
        # Plot outer f and inner trajectories
